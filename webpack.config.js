...
const pages = [
  ...
  parts.page({
    ...
    path: 'buy',
    entry: {
      buy: path.join(paths.app, 'buy')
    },
    template: path.join(paths.app, 'buy/buy.pug'),

    chunks: ['buy', 'runtime', 'vendors']
  }),
  parts.page({
    title: 'Contacts',
    path: 'contacts',
    ...
    chunks: ['contacts', 'runtime', 'vendors']
  }),
  parts.page({
    title: 'Build',
    path: 'build',
    entry: {
      build: path.join(paths.app, 'build')
    },
    template: path.join(paths.app, 'build/build.pug'),

    chunks: ['build', 'runtime', 'vendors']
  }),
  parts.page({
    title: 'documents',
    path: 'documents',
    entry: {
      documents: path.join(paths.app, 'documents')
    },
    template: path.join(paths.app, 'documents/documents.pug'),

    chunks: ['documents', 'runtime', 'vendors']
  }),
  parts.page({
    title: 'news',
    path: 'news',
    entry: {
      news: path.join(paths.app, 'news')
    },
  ...
  parts.page({
    ...
    path: 'parking',
    entry: {
      parking: path.join(paths.app, 'parking')
    },
    template: path.join(paths.app, 'parking/parking.pug'),

    chunks: ['parking', 'runtime', 'vendors']
  })
]
